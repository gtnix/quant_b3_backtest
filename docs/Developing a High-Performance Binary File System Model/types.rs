// types.rs - Core data structures for OBFS (Optimized Binary File System)
...
pub struct Metadata {
    ...
    pub mode: String, // "standard", "compiled", "fast"
}
...
pub struct TimeseriesRow {
    ...
    pub date_offset: i32, // Days since epoch (2020-01-01)
    pub equity: f32,
    pub drawdown: f32,
    pub exposure: f32,
    // Optional columns (mostly null)
