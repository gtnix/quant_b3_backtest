"""Centralized symbol management for US markets.

This module provides a single source of truth for all US trading symbols,
...
# =============================================================================
# TEST SYMBOLS - For unit tests and quick validation (no file dependency)
# =============================================================================

TEST_SYMBOLS_US: List[str] = [
    "AAPL", "MSFT", "GOOGL", "AMZN", "NVDA",
    "META", "TSLA", "BRK-B", "JPM", "SPY",
]

# Top 20 US stocks by market cap (for sample universes)
TOP_20_US: List[str] = [
    "AAPL", "MSFT", "GOOGL", "AMZN", "NVDA",
...
# =============================================================================
# S&P 500 SYMBOLS - Fallback list (updated Jan 2026)
# =============================================================================
...
def get_test_symbols(n: int = 10) -> List[str]:
    """Get test symbols for unit tests.
...
def get_sp500_fallback() -> List[str]:
    """Get hardcoded S&P 500 list (fallback if Wikipedia fails).
    
    Returns:
        List of all S&P 500 symbols
    """
