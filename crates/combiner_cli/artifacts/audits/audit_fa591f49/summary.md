...
**Audit ID**: `audit_8ebdd199`

**Config**: `/home/bahuan/Documents/GitHub/quant_b3_backtest/.tmp/.tmpvdwWcP/manifest.json`
...
|-------|------|-----------|--------|----------|
| 0 | Inicialização da Campanha | Fail | 0/5 passed | 0 ms |
...
**Summary**: 5 checks: 0 passed, 0 warnings, 5 failed
...
| ❌ output_structure | Fail | Diretórios ausentes: ["hall_of_fame", "generations"] |
...
| Check | Veredicto | Mensagem |
|-------|-----------|----------|
| ⚠️ wfa_present | Warn | Diretório hall_of_fame não existe |
| ⚠️ oos_sharpe_threshold | Warn | Ranking não disponível |
| ⚠️ pbo_threshold | Warn | Diretório hall_of_fame não existe |
| ⚠️ dsr_threshold | Warn | Diretório hall_of_fame não existe |
| ⚠️ stress_pass_rate | Warn | Diretório hall_of_fame não existe |
...
| Check | Veredicto | Mensagem |
|-------|-----------|----------|
| ⚠️ bundle_complete | Warn | Diretório hall_of_fame não existe |
| ⚠️ validation_summary_present | Warn | Diretório hall_of_fame não existe |
...
**Summary**: 4 checks: 0 passed, 3 warnings, 1 failed

| Check | Veredicto | Mensagem |
|-------|-----------|----------|
| ❌ provenance_complete | Fail | Manifest não encontrado |
| ⚠️ all_files_present | Warn | Diretório hall_of_fame não existe |
